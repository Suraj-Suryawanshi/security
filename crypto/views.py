        ...
        if form.is_valid():
            try:
                ...
                try:
                    ...
                    return render(request, 'crypto/encrypted.html', {'result': y})
                except:
                    messages.success(
                        request, 'Something went wrong try after some time.')
...
def encrypted(request):
    return render(request, 'crytpo/encrypted.html')
 

def decrypted(request):
    return render(request, 'crypto/decrypted.html')
